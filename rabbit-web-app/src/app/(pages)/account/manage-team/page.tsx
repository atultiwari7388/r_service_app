...
//         await fetchCurrentUserVehicles(authUser.uid);
//         fetchTeamMembersWithVehicles(role, ownerId, authUser.uid);
//       }
//     };
//     fetchData();
//   }, [authUser]);
...
//       // If user is not owner, use their ownerId
//       if (userRole !== "Owner" && userCreatedBy) {
//         effectiveOwnerId = userCreatedBy;
//       }

//       // First get the current user's vehicle IDs if they're a manager/accountant
//       let currentUserVehicles: string[] = [];
//       if (userRole !== "Owner") {
//         const currentUserVehiclesSnapshot = await getDocs(
//           collection(db, "Users", currentUid, "Vehicles")
//         );
//         currentUserVehicles = currentUserVehiclesSnapshot.docs.map(
//           (doc) => doc.id
//         );
//         console.log("Current user vehicles:", currentUserVehicles);
//       }

//       // Get all users created by the owner
...
//         // For non-owners, only process drivers
...
//         // For non-owners, check if member shares any vehicles with current user
//         if (userRole !== "Owner") {
//           const hasSharedVehicle = memberVehicles.some((vehicle) =>
//             currentUserVehicles.includes(vehicle.id)
//           );
