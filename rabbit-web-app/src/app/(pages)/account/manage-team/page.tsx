...
//     const fetchCurrentUserDetails = async (uid: string) => {
//       try {
...
//       fetchCurrentUserVehicles();
//       fetchTeamMembers();
//     }
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [user]);

//   const fetchCurrentUserVehicles = async () => {
//     if (!user) return;
//     try {
...
//         );
//       } else {
//         // Managers/Accountants only see drivers who share vehicles
//         membersQuery = query(
//           collection(db, "Users"),
//           where("createdBy", "==", user.uid),
//           where("role", "==", "Driver")
...
//         // Skip if not owner and doesn't share vehicles
//         if (userRole !== "Owner") {
//           const vehiclesSnapshot = await getDocs(
//             collection(db, "Users", doc.id, "Vehicles")
//           );
//           const memberVehicleIds = vehiclesSnapshot.docs.map((v) => v.id);
//           const sharesVehicle = memberVehicleIds.some((id) =>
//             currentUserVehicleIds.includes(id)
//           );
...
//       setFilteredMembers(membersData.filter((member) => member.active));
//     } catch (error) {
//       console.error("Error fetching team members:", error);
