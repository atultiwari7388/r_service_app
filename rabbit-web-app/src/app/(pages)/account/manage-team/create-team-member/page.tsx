...
//           {/* Basic Info Fields - Common for all roles */}
//           <div className="space-y-4">
//             <input
//               type="text"
//               placeholder="Name"
...
//                 {/* Pay Type Selection for non-Vendor */}
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700">
//                     Pay Type
//                   </label>
...
//                 {/* Vehicle Assignment for Driver, Manager, Accountant, Other Staff */}
//                 {(formData.role === "Driver" ||
//                   formData.role === "Manager" ||
//                   formData.role === "Accountant" ||
//                   formData.role === "Other Staff") && (
...
//                 {/* Access Controls for non-Vendor */}
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-2">
//                     Record Access
//                   </label>
...
//                 {/* Cheque Access for Manager and Accountant */}
//                 {(formData.role === "Manager" ||
//                   formData.role === "Accountant") && (
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 mb-2">
