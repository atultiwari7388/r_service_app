...
//           setSelectedVehicles(data.assignedVehicles);
//           // setMemberVehicles(memberVehiclesList as Vehicle[]);

//           // Fetch member's vehicles
//           // const vehiclesSnapshot = await getDocs(
//           //   collection(db, "Users", memberId, "Vehicles")
//           // );
//           // const memberVehiclesList = vehiclesSnapshot.docs.map((doc) => ({
//           //   id: doc.id,
//           //   ...doc.data(),
//           // }));
//           // setMemberVehicles(memberVehiclesList as Vehicle[]);
...
//     const currentVehicleIds = memberVehicles.map((v) => v.id);
...
//       // Then delete the vehicle reference
...
//                     {/* <input
//                       type="date"
//                       value={formData.licenseExpiryDate?.toString() || ""}
//                       onChange={(e) =>
//                         handleDateChange(
//                           "licenseExpiryDate",
...
//                     {/* <input
//                       type="date"
//                       value={formData.lastDrugTestDate?.toString() || ""}
//                       onChange={(e) =>
//                         handleDateChange(
//                           "lastDrugTestDate",
//                           e.target.valueAsDate
...
//                     {/* <input
//                       type="date"
//                       value={formData.dateOfHire?.toString() || ""}
//                       onChange={(e) =>
...
//                   {/* <input
//                     type="date"
//                     value={formData.dateOfTermination?.toString() || ""}
//                     onChange={(e) =>
//                       handleDateChange(
//                         "dateOfTermination",
//                         e.target.valueAsDate
