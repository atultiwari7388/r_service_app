...
export default function TermsCondition() {
  ...
  const staticTermsAndConditions = `
    ...
    <p>In order to use this Website/App known as 'TrenoOps', you hereby agreeing with undertaking to comply with terms and condition mentioned hereinafter and you shall remain bound for the same, failing which or not to agree any of the terms mentioned hereinafter, then you should not be able to use this Website/App in any manner whatsoever. The words "us", "we" and "our", all refer to TrenoOps App in terms of this "TrenoOps App", are powered by Regal Application LLC. The word "you" refers as terms to user or viewer of this website.</p>
    ...
    <h3 class="text-xl font-semibold text-gray-800 mt-6 mb-2">4. General Provisions</h3>
