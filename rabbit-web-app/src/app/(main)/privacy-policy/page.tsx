...
export default function PrivacyPolicy(): JSX.Element {
  ...
  const staticPrivacyPolicy = `
    ...
    <p>We are hereby providing you the TrenoOps Service for dedicating to protect your privacy online and understand that you necessitate dealing with and protecting any identifiable personal information to be provided to us by you or on your behalf.</p>
    <p>In order to assist you understand as to how we arrange to handle your personal information, TrenoOps Service has been creating this policy of privacy online.</p>
    ...
    <p>If you opted to provide us your personal information, then the TrenoOps Service may hold the same in the ways as follows to:</p>
    <ol class="list-decimal pl-6 space-y-2">
      ...
      <li>Manage and grow up TrenoOps Service's operations and its businesses;</li>
      <li>Safeguard you as well as TrenoOps Service from any kind of scams or fraud and errors;</li>
      <li>Get to know you in the other ways so that TrenoOps Service may better understand your needs and the goods and/or services, which you might need or be in the business of providing, depending on your situation;</li>
    </ol>
    
    <h3 class="text-xl font-semibold text-gray-800 mt-6 mb-2">4. Our revelations towards Your Personal Information</h3>
    <p>If you choose to provide to us, then the TrenoOps Service will have right to disclose your personal information to the parties as follows:</p>
    <ol class="list-disc pl-6 space-y-2">
      <li>To a third party, who needs for such information to help TrenoOps Service with its general administration and/or for the purpose of business operations;</li>
      <li>To that of a third party if the information was given via a website that of a third party owns;</li>
      <li>To a third party indicates interest in purchasing all or any part of TrenoOps Service's business operations;</li>
      <li>To a third party where such revelation is predetermined by law.</li>
    </ol>
    <p>TrenoOps Service shall have at its option publish just the Names of company of the User Pass Account holders, but it never "sells" or otherwise gives away Personal Information regarding User Pass Account holders to outside parties.</p>
    <p>TrenoOps Service shall have at its discretion further to provide a third party the contact details of all or some/partly of its listed vendors if TrenoOps Service, acting realistically, is convinced that the third party will only use the information to offer those listed vendors a product or service that may be of interest to some or all of them.</p>
    <p>If a User Pass Account holder provides TrenoOps Service input about a vendor they dealt with on the list, TrenoOps Service will have right to share the all of that information or partly with that vendor/s, but only with prior express approval of the user's.</p>
    ...
    <p>As TrenoOps Service's corporate headquarters are in Fresno, so this online privacy statement will be subjected to the privacy and personal data safety system that may intermittently shall be applicable from time to time as effective in Fresno.</p>
  `;
