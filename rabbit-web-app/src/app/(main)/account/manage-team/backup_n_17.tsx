...
//         await fetchCurrentUserVehicles(userId);
//         await fetchTeamMembersWithVehicles(userRole, createdBy, userId);

//         console.log("User details fetched:", userData);
//         console.log("User created by:", createdBy);
//       } else {
//         setErrorMessage("User not found");
//         setLoading(false);
//       }
//     } catch (error) {
//       setErrorMessage(`Error loading user details: ${error}`);
//       setLoading(false);
//     }
//   };

//   // const fetchCurrentUserVehicles = async (userId: string) => {
//   //   try {
//   //     const vehiclesSnapshot = await getDocs(
//   //       collection(db, "Users", userId, "Vehicles")
//   //     );
//   //     setCurrentUserVehicleIds(vehiclesSnapshot.docs.map((doc) => doc.id));
//   //   } catch (error) {
...
//   // ) => {
//   //   try {
//   //     let effectiveOwnerId = currentUid;

//   //     if (userRole !== "Owner" && userCreatedBy) {
//   //       effectiveOwnerId = userCreatedBy;

//   //       const ownerDoc = await getDoc(doc(db, "Users", effectiveOwnerId));
//   //       const teamMembers = ownerDoc.data()?.teamMembers || [];

//   //       console.log("Owner's data fetched:", ownerDoc.data());
//   //       console.log("teamMembers array:", teamMembers);
//   //       console.log("currentUid:", currentUid);

//   //       if (!ownerDoc.exists) {
//   //         setErrorMessage("Owner document not found");
//   //         setLoading(false);
//   //         return;
//   //       }

//   //       const isTeamMember = teamMembers.includes(currentUid);
//   //       console.log("Is team member:", isTeamMember);

//   //       if (!isTeamMember) {
//   //         setErrorMessage("You are not authorized to view this team");
//   //         setLoading(false);
//   //         return;
//   //       }
//   //     }

//   //     // Fetch all users created by the effective owner
...
//   //       console.log("Member Name:", memberData.userName);
//   //       console.log("Vehicles for member:", vehicles);

//   //       if (userRole !== "Owner") {
//   //         const sharesVehicle = vehicles.some((vehicle) =>
//   //           currentUserVehicleIds.includes(vehicle.id)
//   //         );
...
//   //     updateAvailableRoles(membersWithVehicles);
//   //     setLoading(false);
//   //   } catch (error) {
//   //     console.error("Error fetching team members:", error);
//   //     setErrorMessage(`Error loading team members: ${error}`);
//   //     setLoading(false);
//   //   }
//   // };
...
//       console.log("Current user vehicle IDs:", vehicleIds); // For debugging
//     } catch (error) {
//       console.error("Error fetching vehicles:", error);
//     }
//   };
...
//         // For non-Owner roles, we only want to show Drivers
//         if (userRole !== "Owner" && memberRole !== "Driver") continue;
...
//         // For non-Owner roles, check if they share any vehicles with this member
//         if (userRole !== "Owner") {
//           const memberVehicleIds = vehicles.map((v) => v.id);
//           const sharesVehicle = currentUserVehicleIds.some((id) =>
//             memberVehicleIds.includes(id)
//           );
...
//   const updateAvailableRoles = (members: TeamMember[]) => {
...
//     console.log("Active members results ", results);
...
//       fetchTeamMembersWithVehicles(role, ownerId, currentUserId);
//     } catch (error) {
