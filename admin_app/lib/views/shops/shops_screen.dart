...
class ShopsScreen extends StatefulWidget {
  static const String id = "manage_mechanics_screen";
...
class _ShopsScreenState extends State<ShopsScreen> {
  ...
  late Stream<List<DocumentSnapshot>> _mechanicStream;
  int _perPage = 10;
  int _currentPage = 0;
  DateTime? _startDate;
  DateTime? _endDate;
  ...
  void initState() {
    super.initState();
    _mechanicStream = _mechanicStreamData();
  }

  Stream<List<DocumentSnapshot>> _mechanicStreamData() {
    Query query = allMechanicsList;
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      ...
                      setState(() {
                        _mechanicStream =
                            _mechanicStreamData(); // Update the stream
                      });
                    },
                  ),
                ),
      ...
      child: Column(
        children: [
          ...
          TextField(
            ...
            onChanged: (value) {
              setState(() {
                _mechanicStream = _mechanicStreamData(); // Update the stream
              });
            },
          ),
          SizedBox(height: 30),
