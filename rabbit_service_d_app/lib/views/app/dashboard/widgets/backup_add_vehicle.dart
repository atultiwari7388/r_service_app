...
//   //         if (defaultValue['brand'] == _selectedEngineName) {
//   //           int notificationValue =
//   //               (int.tryParse(defaultValue['value'].toString()) ?? 0) * 1000;
//   //           int nextMiles = currentMiles + notificationValue;

//   //           // Create notification object for each matching dValue
//   //           nextNotificationMiles.add({
//   //             'serviceName': serviceName,
//   //             'nextNotificationValue': nextMiles,
//   //             'subServices': subServices.map((s) => s['sName']).toList(),
//   //           });
//   //         }
//   //       }
//   //     }
